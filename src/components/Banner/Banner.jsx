    ...
    return (
        <div className='flex h-full mb-10 justify-between items-center max-w-5xl mx-auto'>
            <div className='flex-1 ml-5'>
                ...
                <a href="/src/assets/Md Morshed_MERN Stack Developer.pdf" className='btn btn-neutral hover:text-black hover:bg-white hover:border-2 mt-3 text-xl' download="/src/assets/Md Morshed_MERN Stack Developer.pdf">Resume</a>
