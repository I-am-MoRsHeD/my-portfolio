    ...
    return (
        <div className='flex h-full justify-between items-center max-w-5xl mx-auto'>
            <div className='flex-1 ml-5'>
                ...
                <a href="https://drive.google.com/file/d/1DMd4OQ_DLVRQDCEOmn3HILBXB2axAv63/view?usp=sharing" className='btn btn-neutral hover:text-black hover:bg-white hover:border-2 mt-3 text-lg lg:text-xl' download>Resume</a>
